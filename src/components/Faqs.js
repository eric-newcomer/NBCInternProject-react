            ...
            <div className="Faqs" id="FAQs">
                ...
                <Accordion>
                    <Card>
                        ...
                        <a href="#arrow">Who should apply for internship positions?<i className="material-icons">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
                    ...
                    <Card>
                        ...
                        <a href="#arrow">Who should apply for associate positions?<i class="material-icons">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
                    ...
                    <Card>
                        ...
                        <a href="#arrow">Are interns provided with housing?<i class="material-icons">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
                    ...
                    <Card>
                        ...
                        <a href="#arrow">What opportunities are there outside of work?<i class="material-icons" id="arrow-down">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
                    ...
                    <Card>
                        ...
                        <a href="#arrow">What opportunities are there after the intern program?<i class="material-icons" id="arrow-down">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
                    ...
                    <Card>
                        ...
                        <a href="#arrow">What is the difference between the Intern and Associate’s program?<i class="material-icons" id="arrow-down">keyboard_arrow_down</i></a>
                        </Accordion.Toggle>
